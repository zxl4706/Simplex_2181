...
//struct implementation according to the textbook
struct OBB {
	vector3 c; // OBB center point
	std::vector<vector3> u; // Local x-, y-, and z-axes
...
uint MyRigidBody::SAT(MyRigidBody* const a_pOther)
{
	...
	*/
	...
	//attributes needed for the method's implementation
	float ra, rb;
	matrix3 R = m_m4ToWorld;
	matrix3 AbsR;

	//create list for the different axis of the object
	std::vector<vector3> a_AXISLIST;
	a_AXISLIST.push_back(m_m4ToWorld * vector4(1.f, 0.f, 0.f, 0.f));
	a_AXISLIST.push_back(m_m4ToWorld * vector4(0.f, 1.f, 0.f, 0.f));
	a_AXISLIST.push_back(m_m4ToWorld * vector4(0.f, 0.f, 1.f, 0.f));

	std::vector<vector3> b_AXISLIST;
	b_AXISLIST.push_back(a_pOther->GetModelMatrix() * vector4(1.f, 0.f, 0.f, 0.f));
	b_AXISLIST.push_back(a_pOther->GetModelMatrix() * vector4(0.f, 1.f, 0.f, 0.f));
	b_AXISLIST.push_back(a_pOther->GetModelMatrix() * vector4(0.f, 0.f, 1.f, 0.f));

	//struct of the OBB creation according to textbook
	OBB a;
	a.c = GetCenterGlobal();
	a.u = a_AXISLIST;
	a.e = m_v3HalfWidth;
